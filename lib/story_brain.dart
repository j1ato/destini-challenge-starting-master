...
class StoryBrain {
  ...
  final List<Story> _storyData = [
    Story(
        storyTitle:
            'Your car has blown a tire on a winding road '
    ...
    Story(
        storyTitle:
            'As you begin to drive, the stranger starts talking about his '
                ...
                'Inside you find a bloody knife, two severed fingers, '
                'and a cassette tape of Elton John. '
                'He reaches for the glove box.',
        choice1: 'I love Elton John! Hand him the cassette tape.',
        choice2: 'It\'s him or me! You take the knife and stab him.'),
    Story(
        storyTitle:
            'What? Such a cop out! Did you know '
                'traffic accidents are the second leading '
                'cause of accidental death for most adult age groups?',
        choice1: 'Restart',
        choice2: ''),
    Story(
        storyTitle:
            'As you smash through the guardrail and '
                'careen towards the jagged rocks below you reflect on the '
                'dubious wisdom of stabbing someone '
                'while they are driving a car you are in.',
        choice1: 'Restart',
        choice2: ''),
    Story(
        storyTitle:
            'You bond with the murderer while crooning verses'
                ' of "Can you feel the love tonight". He drops you '
                'off at the next town. Before you go he asks you if you '
                'know any good places to dump bodies.'
